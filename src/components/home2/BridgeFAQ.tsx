...
export function BridgeFAQ() {
  ...
  return (
    <section className="border-t border-[#e8e8e8] bg-[#f4f4f1] py-16 lg:py-24">
      <div className="mx-auto container px-6 lg:px-10">
        <p className="text-[13px] uppercase tracking-[0.08em] text-[#666]">Frequently asked questions</p>
        <h2 className="mt-3 text-[2rem] font-normal tracking-[-0.02em] text-[#3d3d3d] lg:text-[2.5rem]">
        ...
        <div className="mt-10 divide-y divide-[#d8d8d8] border-y border-[#d8d8d8]">
          {faqs.map((faq, i) => (
            <div key={i}>
              ...
              >
                <span className="text-base font-medium text-[#3d3d3d] lg:text-lg">{faq.q}</span>
                <span className="mt-0.5 shrink-0 text-[#3d3d3d]">
