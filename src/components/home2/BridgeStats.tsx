...
export function BridgeStats({ content }: Props) {
  return (
    <section className="bg-white py-16 lg:py-24">
      ...
      <div className="text-center leading-0 -mb-[50px] md:-mb-[38px] lg:-mb-[35px] xl:-mb-[43px] md:text-[75px] pt-28 xl:text-[8.3rem] 2xl:text-[9.4rem] lg:text-[6.3rem] whitespace-nowrap text-[#F4F4F1] text-[45px] font-bold">ZerofAI Intelligence</div>
