...
export function BridgeWhatIs({ content }: Props) {
  ...
  return (
    <section id="what-is" className="bg-background">
      ...
      <div className="text-center capitalize -mb-[14px] md:-mb-[30px] lg:-mb-[35px] xl:-mb-[55px]  xl:text-[8.2rem] md:text-[65px] pt-20 lg:text-[5.5rem] whitespace-nowrap text-[#EFF2F5] text-[35px] font-bold">Transformation Stories</div>
